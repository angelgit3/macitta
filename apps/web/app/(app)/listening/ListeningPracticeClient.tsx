            ...
            <div className="mt-7 grid gap-5 lg:grid-cols-[minmax(0,1fr)_360px]">
                <section className="relative overflow-hidden rounded-[2rem] border border-border bg-surface p-6 sm:p-9">
                    ...
                    <div className="relative flex items-start justify-between gap-4">
                        <div>
                            <p className="text-[0.6875rem] font-bold text-accent">{current.unit.kind === "long" ? "Audio largo · 5 preguntas" : "Micro listening"}</p>
                    ...
                    {heard ? <div className="relative mt-8">
                        <p className="text-[0.6875rem] font-bold text-ink-faint">{current.reason === "recovery" ? "Recuperación" : current.reason === "weak_ear" ? "Oído prioritario" : current.reason === "long_set" ? "Comprensión conectada" : "Escucha activa"}</p>
                ...
                <aside className="space-y-4">
                    <div className="rounded-3xl border border-border bg-surface/70 p-5"><p className="text-xs font-bold text-ink-faint">Regla de oro</p><p className="mt-3 font-bold leading-6 text-ink">No pauses para traducir. Busca intención, contraste y consecuencia.</p></div>
