...
import { safeInternalRedirect } from "@macitta/shared/src/security";
...
export const config = {
    matcher: [
        "/((?!_next/static|_next/image|favicon.ico|manifest\\.json|robots\\.txt|sitemap\\.xml|sw\\.js|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|woff|woff2|ttf|eot|mp3|wav|ogg)$).*)",
    ],
};
