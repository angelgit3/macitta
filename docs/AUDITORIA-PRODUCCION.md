...
2. ~~Buzón de contacto~~ **Resuelto:** las páginas legales publican `macitta.app@gmail.com`, buzón real e independiente del dominio (importante si se deja de pagar `macitta.app` — el contacto legal sobrevive al dominio).
